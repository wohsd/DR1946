...
NMilitary = {
	...
	HOURS_REQ_REJOIN_BORDER_WAR_FOR_INJURED_UNITS = -1, -- minimum hours required for units to rejoin border wars
...
NAI = {
	...
	DIPLOMACY_ACCEPT_VOLUNTEERS_BASE = 10000,		-- Base value of volunteer acceptance (help is welcome)
